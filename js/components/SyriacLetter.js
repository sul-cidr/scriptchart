...
export const letters = [
    ...
    { id: 48, letter: "Yudh (Connected)", is_script: true, display: "ܝ", script: "estrangela", leading_letter: "ܝ", trailing_letter: "ܝ" },
    { id: 49, letter: "Yudh (Stand-alone)", is_script: true, display: "ܝ", script: "estrangela" },
    { id: 19, letter: "Kaph", is_script: true, display: "ܟ", script: "estrangela", leading_letter: "ܝ" },
    ...
    { id: 21, letter: "Lamadh", is_script: true, display: "ܠ", script: "estrangela", trailing_letter: "ܝ" },
    { id: 23, letter: "Lamadh (Final, closed)", is_script: true, display: "ܠ", script: "serto" },
    { id: 26, letter: "Mim", is_script: true, display: "ܡ", script: "estrangela", leading_letter: "ܝ" },
    { id: 27, letter: "Mim (Final)", is_script: true, display: "ܡ", script: "estrangela"},
    { id: 28, letter: "Nun", is_script: true, display: "ܢ", script: "estrangela", leading_letter: "ܝ" },
    { id: 30, letter: "Nun (Final, connected)", is_script: true, display: "ܢ", script: "estrangela", trailing_letter: "ܝ" },
    ...
    { id: 37, letter: "Sadhe", is_script: true, display: "ܨ", script: "estrangela" },
    ...
    { id: 44, letter: "Taw (Triangular)", is_script: true, display: "ܬ", script: "serto", trailing_letter: "ܝ" },
